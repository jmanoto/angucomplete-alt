...
angular.module('angucomplete-alt', [] )
  ...
  $templateCache.put(TEMPLATE_URL,
      ...
      '    <div class="angucomplete-row" ng-repeat="result in results" ng-click="selectResult(result)" ng-mouseenter="hoverRow($index)" ng-class="{\'{{dropdownRowClass ||  \'angucomplete-selected-row\' }}\': $index == currentIndex}">' +
